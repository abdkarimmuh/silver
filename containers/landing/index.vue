      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 d-flex flex-column justify-content-center">
            <h6 class="text-warning mb-2">About us</h6>
            ...
            <p class="mb-5">
              ...
              doloremque nostrum, fuga fugit minima quod delectus magni
    ...
    <section class="miri-ui-kit-section">
      <div class="container">
        <div class="d-md-flex justify-content-between">
          <div class="px-3 row d-md-flex mt-5">
            <figure class="d-inline-block">
              <figure class="d-inline-block">
                <img src="~/assets/images/img_1.jpg" class="rounded-circle" />
              </figure>
            </figure>
            <div class="col">
              <div class="pl-3">
                <h3 class="mb-2">Studio</h3>
                <p>
          ...
          <div class="px-3 row d-md-flex mt-5">
            <figure class="d-inline-block">
              <img src="~/assets/images/img_2.jpg" class="rounded-circle" />
            </figure>
            <div class="col">
              <div class="pl-3">
                <h3 class="mb-2">Masjid Community</h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut.
                </p>
      ...
      <div class="container">
        <div class="d-md-flex justify-content-between">
          <div class="px-3 row d-md-flex mt-5">
            <figure class="d-inline-block">
              <img src="~/assets/images/img_3.jpg" class="rounded-circle" />
            </figure>
            <div class="col">
              <div class="pl-3">
          ...
          <div class="px-3 row d-md-flex mt-5">
            <figure class="d-inline-block">
              <img src="~/assets/images/img_4.jpg" class="rounded-circle" />
            </figure>
            <div class="col">
              <div class="pl-3">
                <h3 class="mb-2">Art & Science</h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut.
                </p>
      ...
      <div class="container">
        ...
        <div class="text-center">
          <figure class="d-inline-block mx-2">
            ...
            <figcaption class="text-center py-3 font-weight-medium text-black">
              Image
            </figcaption>
          </figure>
          <figure class="d-inline-block mx-2">
        ...
        <div class="card bg-dark border-0">
          <div class="card-body px-5 py-5">
            <div class="row align-items-center px-5">
              <div class="col-md-6">
                <h3 class="text-white">Gabung Bersama Kami</h3>
                <p class="text-white">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut.
                </p>
          ...
          <div class="col-md-6">
            <div class="bd-example px-3">
              ...
              >
                  ...
                  <div class="carousel-item active">
                    <div class="card border-0">
                      <div class="card-body text-center">
                        ...
                        <p class="font-italic">
                          Achieve virtually any design and layout from with in
                          the
                        </p>
                ...
                <a
                  class="carousel-control-prev"
                  href="#carouselTestimoniCaptions"
                  role="button"
                  data-slide="prev"
                >
                  <i class="mdi mdi-chevron-left"></i>
